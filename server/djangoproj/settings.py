...
ALLOWED_HOSTS = ['localhost','https://codesob30-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
CSRF_TRUSTED_ORIGINS = ['https://codesob30-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
